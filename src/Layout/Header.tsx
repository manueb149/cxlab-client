...
const links = [
  { name: 'Webinars', href: '#', icon: <RightArrowIcon color='blue' width={15} />, cta: false},
  { name: 'Blogs', href: '#', icon: <RightArrowIcon color='green' width={15} />, cta: false }
]
                      ...
                      {products.map((item) => (
                        ...
                        >
                          <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                            <div className="h-6 w-6 text-gray-600 group-hover:text-orange-600" aria-hidden="true">{<item.icon />}</div>
                          </div>
                          <div className="flex-auto">
